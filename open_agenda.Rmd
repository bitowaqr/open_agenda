...
- <span style = "color: darkgray"><input type="checkbox" > 3.4 The EQ-5D-Y OPUF survey UK</span>
- <span style = "color: darkgray"><input type="checkbox" > 3.5 OPUF vs PAPRIKA</span>
-  <input type="checkbox" > 3.6 The 'OPUF Platform' 
